...
def main() -> None:
    ...
    # 85 동남아섭(2026-09-04 제보 계정으로 확인: 194종) · 91 대만·홍콩·마카오. 같은 openid가 두 지역에 걸릴 수 있다
    # (실측: 84 글로벌 32종 + 85 동남아 194종) — 그래서 여러 지역이 잡히면 사람이 고른다.
    AREA_LABEL = {83: "한섭", 81: "일섭", 84: "글로벌섭", 85: "동남아섭", 91: "대만홍콩마카오섭"}
